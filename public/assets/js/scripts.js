function alertAppend(msg, status, msgAttention = '') {
    let alert = '<div class="alert alert-solid alert-' + status + ' mg-b-0" role="alert">\n' +
...
function createNewRowRecord(url, id, appendClass = 'append-container-uploaded') {
    ...
    let appendBlockRecordRow = '<div class="jail-color d-flex align-items-center justify-content-between position-relative px-4 py-2">' +
