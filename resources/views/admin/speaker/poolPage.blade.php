...
@section('content')
    ...
    <form action="{{url('cabinet',['savepool',$pool->key])}}" id="saveform" method="POST" class="uppquestions">
        ...
        <div class="section-wrapper mg-t-20" id="qq1">
            <label class="section-title">Question 1</label>
            <div class="form-layout">
                <div class="row mt-2">
                    <div class="col-md-12">
                        <div class="form-group">
                            <input class="form-control rounded-5" type="text" name="question[1]"
                ...
                <div class="row mt-1 questions">
                    <div class="col-lg-12 mb-2 section-title mb-4 d-flex align-items-center">
                        ...
                        <a href="#" class="btn btn-success px-2 py-1 tx-8 ml-2 rounded font-weight-bold"
                           onclick="newOption(event,1)">Add option</a>
                    </div>
                    <div class="col-lg-3 d-flex align-items-center mb-4" id="qw1">
                        <input class="form-control rounded-5" type="text" value="3 - 14 years" name="checkbox[1][1]"
                               required>
                        <a href="#" class="btn btn-danger rounded-5 ml-2 del-option" data-id="1"><i
                                class="icon ion-close"></i></a>
                    </div>
                    <div class="col-lg-3 d-flex align-items-center mb-4" id="qw2">
                        <input class="form-control rounded-5" type="text" value="15 - 25 years" name="checkbox[1][2]"
                               required>
                        <a href="#" class="btn btn-danger rounded-5 ml-2 del-option" data-id="2"><i
                                class="icon ion-close"></i></a>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function newQuestion(event) {
            ...
            let wrap = '<div class="section-wrapper mg-t-20" id="qq' + questionCount + '">' +
                '<label class="section-title">Question ' + questionCount + '</label>' +
                '<div class="form-layout">' +
                '<div class="row mt-2">' +
                '<div class="col-md-12">' +
                '<div class="form-group">' +
