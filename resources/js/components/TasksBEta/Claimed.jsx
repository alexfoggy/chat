...
class Claimed extends Component {
    ...
    componentDidMount() {
        axios.get(`http://127.0.0.1:8000/api/users/${getToken()}/tasks?filter=claimed`)
            .then(res => {
                this.setState({
                    ...
                    >
                        <div className="task" style={{ width: '100%' }}>
                            ...
                            <div className="buttons">
                                ...
                                <NavLink to={'/cabinet/tasks/' + t.id} className="claim"><i className="flaticon-add"></i>Start</NavLink>
